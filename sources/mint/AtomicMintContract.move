module free_tunnel_sui::atomic_mint {
    ...
    use mbtc::access_control::{AccessConfig, MinterCap, BurnerCap};
    use mbtc::mbtc::{mint, burn, TreasuryCapManager};
    ...
    public entry fun executeBurn<CoinType>(
        ...
        *storeA.proposedBurn.borrow_mut(reqId) = EXECUTED_PLACEHOLDER;
        ...
        burn(
            ...
            storeA.burnerCaps.borrow(tokenIndex), mbtcConfig
        );
